...
if ($_GET[module]=='store'){
     ...
     echo " 
            </div><div class='profil2'><b>Selamat Datang di Jelly Mie - Your Mouth Your Art</b><br />
<p>Kami menyediakan dessert dengan nama identitas Jelly Mie. Berkonsep mie dengan tekstur jelly yang dipadukan dengan sirup dan buah-buahan segar.
Sangat cocok dinikmati saat anda lapar dan haus.<br>
...
if ($_GET['module']=='profilkami'){
  ...
  echo "<h4 class='heading colr'>Profil Kami</h4>
          ...
          <div class='profil'>
              <div><p>Jelly Mie - Your Mouth Your Art<br>
Kami menyediakan dessert dengan nama identitas Jelly Mie. Berkonsep mie dengan tekstur jelly yang dipadukan dengan sirup dan buah-buahan segar. Sangat cocok dinikmati saat anda lapar dan haus.</p>

<p>Akhirnya, kami mengucapkan terima kasih atas kunjungan anda di Jelly Mie - Your Mouth Your Art.</p></div>
...
elseif ($_GET[module]=='keranjangbelanja'){
  ...
  echo "<tr><td colspan=5 align=right><br><span class='table3'>Total:</td><td colspan=2><br><span class='table3'>Rp. $total_rp,-</b></td></tr>
        <tr><td colspan=2><br /><a href=semua-produk.html><input style='width: 135px; height: 22px;' type=submit  class= simplebtn value='LANJUTKAN MEMESAN'></a><br /></td>
        <td colspan=2><br /><input style='width: 130px; height: 22px;' type=submit  class= simplebtn value='UPDATE PESANAN'><br /></td>
        </tr>
        </tbody>
  </table>";
