...
if ($_GET['module']=='detailproduk'){
  ...
  $harga = format_rupiah($d['harga']);
   ...
   //cek stok untuk tampilkan tombol pesan dan habis
    $stok=$d['stok'];
    $tombolpesan="<a class='addtocart' href=\"aksi.php?module=keranjang&act=tambah&id=$d[id_produk]\">pesan</a>";
    $tombolhabis="";
      if ($stok!= "0"){
      $tombol=$tombolpesan;
      }else{
...
// Produk Lainnya (random)          
  ...
  //cek stok untuk tampilkan tombol pesan dan habis
    $stok=$r['stok'];
    $tombolpesan="<a class='prod_cart_pesan' href=\"aksi.php?module=keranjang&act=tambah&id=$r[id_produk]\">pesan</a>";
 ...
 echo "<div class='prod_box'>
          ...
          <div class='prod_details_tab'>
             <a href='aksi.php?module=keranjang&act=tambah&id=$r[id_produk]' class='prod_cart'>pesan</a>            
